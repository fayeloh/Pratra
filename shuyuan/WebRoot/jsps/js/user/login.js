$(function() {
	...
	$("#submit").hover(
		function() {
			$("#submit").attr("src", "/shuyuan/images/login2.jpg");
		},
		function() {
			$("#submit").attr("src", "/shuyuan/images/login1.jpg");
		}
	);
...
function _hyz(){
	 ...
	 * 3。以毫秒增加参数
	 * */
	$("#vCode").attr("src","/shuyuan/VerifyCodeServlet?a="+new Date().getTime());
}
/*
