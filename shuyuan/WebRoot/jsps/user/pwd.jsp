...
<html>
  <head>
	...
	<script type="text/javascript" src="<c:url value='/jsps/user/pwd.js'/>"></script>
  </head>
	...
	<div class="div1">
		...
		<table>
			...
			<tr>
				...
				<td><input class="input" type="password" name="reloginpass" id="reloginpass" value="${user.newpass }"/></td>
